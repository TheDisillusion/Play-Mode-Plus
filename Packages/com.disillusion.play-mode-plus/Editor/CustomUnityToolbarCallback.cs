...
namespace PlayModePlus.Editor
{
    public static class CustomUnityToolbarCallback
    {
        ...
        private static void OnUpdate()
        {
            ...
            var playModeToolbarPlus = new PlayModeToolbar();
            mRoot.Q("ToolbarZoneRightAlign").Add(playModeToolbarPlus);
        ...
        {
            var toolbarZone =
                (VisualElement) _mCurrentToolbar?.GetType().GetProperty(root)?.GetValue(_mCurrentToolbar);
