...
- Comprehensive documentation:
  ...
  - `TESTING_GUIDE.md` - 21 detailed test cases
  - `IMPLEMENTATION_NOTES.md` - Technical deep-dive
  - `CHANGELOG.md` - This file

### Changed
- Refactored from reflection-based to attribute-based toolbar registration
- Replaced `IMGUIContainer` with `MainToolbarButton` and `MainToolbarDropdown`
...
- Preserves all original functionality from v2.x
