...
namespace PlayModePlus.Editor
{
    public class PlayModeToolbar : VisualElement
    {
        ...
        private readonly Texture2D _playButtonTexture =
            AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/PlayModePlus/Editor/Icons/CustomPlayButton.png");

        private readonly Texture2D _playStopButtonTexture =
            AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/PlayModePlus/Editor/Icons/CustomPlayStopButton.png");

        public PlayModeToolbar()
        {
            var visualTree =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Assets/PlayModePlus/Editor/PlayModePlusToolbar.uxml");
            ...
            {
                if (_selectSceneDropdown.value == "Add Scene...")
                {
                    _selectSceneDropdown.value = null;
